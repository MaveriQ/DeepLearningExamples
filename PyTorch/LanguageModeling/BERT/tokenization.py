...
def load_vocab(vocab_file):
    """Loads a text and pos/tags vocabulary file into a dictionary."""
...
class BertTokenizer(object):
    ...
    def __init__(self, vocab_file, do_lower_case=True, max_len=None,
        ...
        self.wordpiece_tokenizer = WordpieceTokenizer(vocab=self.vocab,spacy_nlp=self.nlp)
    ...
    def convert_tokens_to_ids(self, tokens):
        ...
        for token in tokens:
            if token in ("[UNK]", "[SEP]", "[PAD]", "[CLS]", "[MASK]"):
                ...
                pos_ids.append(self.tags_vocab.get(token[1],0))
...
class WordpieceTokenizer(object):
    ...
    def tokenize(self, basic_tokens):
        ...
        for token in basic_tokens: # whitespace_tokenize(basic_tokens):
            pos=token[1]
            token=token[0]
            chars = list(token)
