...
class pretraining_dataset(Dataset):
    ...
    def __init__(self, input_file, max_pred_length):
        ...
        keys = ['input_ids', 'tag_ids', 'input_mask', 'segment_ids', 'masked_lm_positions', 'masked_lm_ids', 'masked_lm_tags',
    ...
    def __getitem__(self, index):
        ...
        [input_ids, tag_ids, input_mask, segment_ids, masked_lm_positions, masked_lm_ids, masked_lm_tags, next_sentence_labels] = [
        ...
        return [input_ids, tag_ids, segment_ids, input_mask,
                masked_lm_labels, masked_lm_tags, next_sentence_labels]
